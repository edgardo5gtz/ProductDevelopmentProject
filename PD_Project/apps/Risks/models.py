...
class RiskType(models.Model):
    ...
    risk = models.ForeignKey(Risk, related_name="risk_type", on_delete=models.CASCADE, null=True, blank=True)
...
class RiskField(models.Model):
    ...
    risk_type = models.ForeignKey(RiskType, related_name='risk_field', on_delete=models.CASCADE,null=True, blank=True)
...
class DateFieldVal(models.Model):
    ...
    risk_field = models.ForeignKey(RiskField, related_name='date_field', on_delete=models.CASCADE, null=True, blank=True)
...
class EnumFieldVal(models.Model):
    ...
    risk_field = models.ForeignKey(RiskField, related_name='enum_field', on_delete=models.CASCADE, null=True, blank=True)
...
class TextFieldVal(models.Model):
    ...
    risk_field = models.ForeignKey(RiskField, related_name='text_field', on_delete=models.CASCADE, null=True, blank=True)
...
class NumberFieldVal(models.Model):
    ...
    risk_field = models.ForeignKey(RiskField, related_name='number_field', on_delete=models.CASCADE, null=True, blank=True)
